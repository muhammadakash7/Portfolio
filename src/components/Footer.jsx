  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img style={{width:'45px'}} src={logo} alt="Logoipsum" />
        </div>
          ...
          <ul>
            ...
            <li>
              <a
                ...
                href="https://www.linkedin.com/in/muhammad-akash-7ma"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div>
      <p>Thank you for visiting my portfolio, and I look forward to the possibility of working together!</p>
      </div>
      <hr className="divider" />
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Muhammad Akash</p>
        {/* <div className="footer--social--icon">
          <ul>
            <li>
              <Link
