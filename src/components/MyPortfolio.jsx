import redirect from "../assets/images/project.png";
import Video from "../assets/images/Redirect.mp4";
import news from "../assets/images/News.png"
import newsApp from "../assets/images/NewsApp.mp4"
import chat from "../assets/images/chat.png"
import chatApp from "../assets/images/ChatApp.mp4"
  ...
  return (
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a
            href="https://github.com/muhammadakash7"
      ...
      <div className="portfolio--section--container">
        <div className="portfolio--section--card">
          <div className="portfolio--section--img">
            <img src={redirect} alt="Placeholder" />
          </div>
          <div className="portfolio--section--card--content">
            ...
            <div>
              <a
                href="https://github.com/muhammadakash7/Redirect.git"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="portfolio--section--card">
          ...
          <div className="portfolio--section--card--content">
            ...
            <div>
              <a
                href="https://github.com/muhammadakash7/News-App.git"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
              ...
              >
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <video src={newsApp} controls width="100%"></video>
                    </div>
                    <div class="modal-footer">
                      <button
                        type="button"
        ...
        <div className="portfolio--section--card">
          ...
          <div className="portfolio--section--card--content">
            ...
            <div>
              <a
                href="https://github.com/muhammadakash7/CHAT-APP.git"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
              ...
              >
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <video src={chatApp} controls width="100%"></video>
                    </div>
                    <div class="modal-footer">
                      <button
                        type="button"
